...
function AuthPage() {
  ...
  async function continueWithGoogle() {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Erro no acesso com Google");
      setLoading(false);
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-surface">
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="p-6 shadow-card">
          ...
          <Button type="button" variant="outline" disabled={loading} onClick={continueWithGoogle} className="w-full">
